...
- **Directory tree navigation** — browse folders in an embedded side panel or a separate window, with thumbnail previews and sortable image lists; jump to Desktop, Documents, drives, and network locations (on Linux, list thumbnails for some formats may load more slowly than on Windows/macOS; full-size viewing in the main window is unchanged)
