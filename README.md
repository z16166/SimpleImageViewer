...
| **Display** | Full-screen toggle, scale-mode selector, OSD info visibility, tiled-rendering threshold (please leave this unchanged at your graphics device maximum; shown so you can screenshot it when contacting support), **High-Quality RAW preview** toggle, and **Demosaicing Mode (CPU / GPU)** when HQ RAW is enabled |
