# Overlay of `ports/libheif` from microsoft/vcpkg: adds `dav1d` feature (WITH_DAV1D) instead of `-DWITH_DAV1D=OFF`.
# Auxiliary patch files mirror the baseline port; regenerate from `microsoft/vcpkg` if CMake patches stop applying after version bumps.
...
vcpkg_check_features(OUT_FEATURE_OPTIONS FEATURE_OPTIONS
    FEATURES
        ...
        experimental-mini ENABLE_EXPERIMENTAL_MINI_FORMAT
...
vcpkg_cmake_configure(
    ...
    OPTIONS
        ...
        # Static viewers: codec plugins default to DLLs (e.g. heif-dav1d.dll) with incomplete Brotli
        # linkage for new Brotli; disable plugin loading so decoders compile into libheif.
