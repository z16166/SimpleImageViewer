...
pub type TIFFReadWriteProc = unsafe extern "C" fn(handle: *mut c_void, buf: *mut c_void, size: tsize_t) -> tsize_t;
pub type TIFFSeekProc = unsafe extern "C" fn(handle: *mut c_void, off: toff_t, whence: c_int) -> toff_t;
...
pub type TIFFMapFileProc = unsafe extern "C" fn(handle: *mut c_void, base: *mut *mut c_void, size: *mut toff_t) -> c_int;
pub type TIFFUnmapFileProc = unsafe extern "C" fn(handle: *mut c_void, base: *mut c_void, size: toff_t);
pub type TIFFErrorHandler = unsafe extern "C" fn(module: *const c_char, fmt: *const c_char, ap: *mut c_void);
